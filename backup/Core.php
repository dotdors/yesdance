...
// TEMPORARY SHOPS SETTINGS STUB - only to allow plugin activation and data access
if (!class_exists('ShoppSettings')) {
    class ShoppSettings {
        public function available() { return true; }
        public function dbversion() { return '0'; }
    }
}

if (!function_exists('ShoppSettings')) {
    function ShoppSettings() {
        return new ShoppSettings();
    }
}
/**
