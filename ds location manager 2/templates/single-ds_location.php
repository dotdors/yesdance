...
<div class="ds-location-template">
    ...
    <section class="ds-location-hero">
        ...
        <!-- Curved overlay - path is generated by JS from CSS variables -->
        <div class="ds-location-hero__overlay" aria-hidden="true">
            <svg viewBox="0 0 1200 600" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
                <!-- 
                    Configure in _locations.less:
                    --hero-curve-start: 330   (0=top, 600=bottom)
                    --hero-curve-depth: 80    (positive=down, negative=up)
                    
                    Default path below is fallback if JS doesn't load
                -->
                <path class="ds-location-hero__overlay-shape" 
                      d="M 0,330 Q 600,410 1200,330 L 1200,600 L 0,600 Z" />
            </svg>
        </div>
