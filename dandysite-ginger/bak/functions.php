...
function dandysite_ginger_register_block_patterns() {
    ...
    register_block_pattern(
        ...
        array(
            ...
            'content' => '<!-- wp:group {"className":"hero-section","style":{"spacing":{"minHeight":"100vh","padding":{"top":"4rem","bottom":"4rem"}},"color":{"background":"#2563eb"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group hero-section has-background" style="background-color:#2563eb;min-height:100vh;padding-top:4rem;padding-bottom:4rem">
<!-- wp:heading {"textAlign":"center","level":1,"style":{"typography":{"fontSize":"4rem","fontWeight":"700"},"color":{"text":"#ffffff"}}} -->
<h1 class="wp-block-heading has-text-align-center has-text-color" style="color:#ffffff;font-size:4rem;font-weight:700">Dance Your Way to Joy</h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"1.25rem"},"color":{"text":"#ffffff"}}} -->
<p class="has-text-align-center has-text-color" style="color:#ffffff;font-size:1.25rem">Discover the joy of movement with our inclusive dance classes</p>
<!-- /wp:paragraph -->

<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"},"style":{"spacing":{"margin":{"top":"2rem"}}}} -->
<div class="wp-block-buttons" style="margin-top:2rem">
<!-- wp:button {"style":{"color":{"background":"#7c3aed","text":"#ffffff"}}} -->
<div class="wp-block-button"><a class="wp-block-button__link has-text-color has-background wp-element-button" style="color:#ffffff;background-color:#7c3aed">Start Dancing Today</a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
</div>
<!-- /wp:group -->'
    ...
    register_block_pattern(
        ...
        array(
            ...
            'categories' => array('dandysite-ginger'),
            'content' => '<!-- wp:group {"className":"dance-steps-section","style":{"spacing":{"padding":{"top":"6rem","bottom":"6rem"}}}} -->
<div class="wp-block-group dance-steps-section" style="padding-top:6rem;padding-bottom:6rem">
...
<!-- /wp:group -->'
    ...
    register_block_pattern(
        ...
        array(
            ...
            'categories' => array('dandysite-ginger'),
            'content' => '<!-- wp:group {"className":"programs-section","style":{"spacing":{"padding":{"top":"4rem","bottom":"4rem"}}}} -->
<div class="wp-block-group programs-section" style="padding-top:4rem;padding-bottom:4rem">
<!-- wp:heading {"textAlign":"center","level":2,"style":{"spacing":{"margin":{"bottom":"3rem"}}}} -->
<h2 class="wp-block-heading has-text-align-center" style="margin-bottom:3rem">Our Dance Programs</h2>
<!-- /wp:heading -->

<!-- wp:columns -->
<div class="wp-block-columns">
<!-- wp:column {"className":"program-card","style":{"spacing":{"padding":{"all":"2rem"}},"border":{"radius":"8px"}}} -->
<div class="wp-block-column program-card" style="border-radius:8px;padding:2rem">
<!-- wp:heading {"level":3} -->
